...
.factory("AuthenticationService",['$http', '$cookies', '$rootScope', '$timeout', 'UserService','WebService',
    function($http, $cookies, $rootScope, $timeout, UserService,WebService) {
        ...
        AuthenticationService.Login = function(username, password,callback){
            console.log("entro a authservice login");

            return  $http.post(WebService.APIREST+'/logeo',username,password)
